...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Alejo mod'],
			['Alejo520',			'alejo520',			'artist and programmer of the mod',						'https://www.youtube.com/channel/UC4fMMJIzPk2Omnjqg7v7hzw',	'7F0000'],
			['ChetXI',				'chetxi',			'musician of mod',										'https://twitter.com/XiChett',			'004A7F'],
			[''],
			['Psych Engine Team'],
